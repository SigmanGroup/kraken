...
The different xTB versions lead to slightly different properties at the GFN2 level. We compared the DFT properties of more
than 60 monophosphines generated by both the original and updated Kraken versions. For a single monophosphine, the differences
between the old and new properties exceed 75% of the original value for a small number of properties (typically octant volumes).
These differences likely arise from stochasticity in the conformer search.
